...
\"\n\
checkout_executable TCLSH \"/home/aviananda/Documents/Tugas_Akhir/ns-allinone-2.35/bin/tclsh8.5\" tclsh \"\\\n\
When configured, ns found the right version of tclsh in\\\n\
/home/aviananda/Documents/Tugas_Akhir/ns-allinone-2.35/bin/tclsh8.5\n\
but it doesn't seem to be there anymore, so\\\n\
